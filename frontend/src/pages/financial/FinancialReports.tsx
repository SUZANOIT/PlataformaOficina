    ...
    <div className="space-y-6 pb-12 print:p-0 print:space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 no-print">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Análise estruturada de Demonstração do Resultado do Exercício e Fluxo de Caixa.</p>
        </div>
      ...
      {/* Relatório Imprimível - DRE Struct */}
      <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-xs print:border-none print:shadow-none print-container space-y-6">
        ...
        <div className="space-y-4">
          ...
          {/* 2. Deduções (Se houver impostos, ou despesas específicas) */}
