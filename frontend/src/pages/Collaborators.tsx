    ...
    <div className="space-y-6">
      ...
      {isAdvanceModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl w-[95%] max-w-4xl shadow-xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-indigo-200 text-xs mt-0.5">
                    Colaborador: <span className="font-semibold text-white">{currentCollabForAdvance?.nome}</span>
                  </p>
                </div>
              </div>
              <button 
            ...
            <div className="p-6 space-y-6 flex-1 overflow-y-auto scrollbar-thin">
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-700/25 border border-gray-200 dark:border-gray-600 p-5 rounded-xl flex flex-wrap gap-8 justify-between items-center text-sm">
                <div className="space-y-1">
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-gray-400 dark:text-gray-500 block">Empresa</span>
                  <span className="font-bold text-gray-800 dark:text-white text-xs block">
                    {currentCollabForAdvance?.company?.razaoSocial || 'Não Vinculada'}
                  </span>
                </div>
                <div className="space-y-1">
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-gray-400 dark:text-gray-500 block">CNPJ</span>
                  <span className="font-mono font-bold text-gray-800 dark:text-white bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-2.5 py-1 rounded-lg text-xs">
                    {currentCollabForAdvance?.company?.cnpj || '—'}
                  </span>
                </div>
                <div className="space-y-1">
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-gray-400 dark:text-gray-500 block">Cargo</span>
                  <div className="flex items-center gap-1.5 text-gray-800 dark:text-white font-semibold text-xs">
                    <Award size={13} className="text-indigo-500" />
                    <span>{currentCollabForAdvance?.cargo || 'Não informado'}</span>
                  </div>
                </div>
                <div className="space-y-1">
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-gray-400 dark:text-gray-500 block">Salário Base</span>
                  <div className="flex items-center gap-1 bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 rounded-xl">
              ...
              <div className="flex justify-between items-center">
                <h4 className="font-bold text-sm text-gray-800 dark:text-white flex items-center gap-2">
                  ...
                  <span className="bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 text-xs px-2.5 py-0.5 rounded-full font-bold">
                    {advances.length}
                  </span>
                </h4>
                {!isCreateAdvanceFormOpen && (
                  <button
                    ...
                    className="flex items-center gap-2 text-xs bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 px-4 rounded-xl shadow-md transition-all hover:scale-105 active:scale-95 duration-150"
                  >
              ...
              {/* Create Advance Form */}
              {isCreateAdvanceFormOpen && (
                <form onSubmit={handleSaveAdvance} className="bg-gray-50 dark:bg-gray-700/50 border border-indigo-500/30 p-6 rounded-xl space-y-4 shadow-lg animate-in slide-in-from-top-4 duration-200">
                  <div className="flex justify-between items-center border-b border-border pb-3">
                    <h5 className="font-bold text-xs text-gray-800 dark:text-white uppercase tracking-wider flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="text-xs text-gray-500 hover:text-gray-800 dark:hover:text-white font-semibold px-2 py-1 rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition"
                    >
                      Cancelar
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800 dark:text-white"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1.5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800 dark:text-white resize-none"
                    />
                  </div>
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <button
                      type="button"
                      onClick={() => setIsCreateAdvanceFormOpen(false)}
                      className="px-4 py-2 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 text-xs font-bold rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition"
                    >
                      Voltar
                    </button>
                    <button
                      ...
                      className="px-5 py-2 bg-indigo-600 text-white text-xs font-bold rounded-lg hover:bg-indigo-700 disabled:opacity-50 transition shadow-sm"
                    >
              ...
              <div className="border border-gray-200 dark:border-gray-600 rounded-xl overflow-hidden bg-white dark:bg-gray-800">
                {loadingAdvances ? (
                  <div className="p-12 text-center text-sm text-gray-400 dark:text-gray-500 flex flex-col items-center justify-center gap-3">
                    <span className="animate-spin text-indigo-500 text-xl font-bold">↻</span>
                    <span>Carregando histórico...</span>
                  </div>
                ) : advances.length === 0 ? (
                  <div className="p-12 text-center text-sm text-gray-400 dark:text-gray-500 space-y-2">
                    <p className="font-semibold text-gray-800 dark:text-white">Nenhum registro encontrado</p>
