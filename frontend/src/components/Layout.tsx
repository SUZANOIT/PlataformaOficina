    ...
    <div className="flex h-screen bg-background text-foreground">
      ...
      <aside className="w-64 bg-card border-r border-border shadow-sm flex flex-col">
        <div className="h-16 flex items-center px-6 border-b border-border">
          <h1 className="text-xl font-bold text-primary">SysOrçamento</h1>
        </div>
        ...
        <div className="p-4 border-t border-border">
          <button 
            ...
            className="flex items-center gap-3 px-3 py-2 w-full text-left rounded-md hover:bg-destructive/10 hover:text-destructive transition-colors"
          >
            <LogOut size={20} />
            <span>Sair</span>
          </button>
