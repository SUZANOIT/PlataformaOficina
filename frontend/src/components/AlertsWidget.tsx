  ...
  return (
    <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
      <div className="p-6 border-b border-border flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold">Alertas e Comunicados</h2>
        {alerts.some(a => !a.lida) && (
          <span className="ml-auto text-[10px] font-bold bg-rose-500/10 text-rose-600 border border-rose-500/20 px-2 py-0.5 rounded-full">
